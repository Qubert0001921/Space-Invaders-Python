...
class Slider(Hittable):
    def __init__(self, value, max_value, pos, width, height, color_bar, color_slider):
        super().__init__()
        self.value = value
    ...
    def draw(self, surface):
        self.collide_boxes = [CollideBox(self.pos_bar.x -25, self.pos_bar.y-25, self.width+50, self.height+50)]
